...
import {MotionPageCard, MotionPressable, MotionStaggerItem} from '@/components/motion-primitives';
    ...
    <SiteShell>
      <section className="wide-page flex min-h-dvh items-center px-4 py-10 sm:px-6">
        <div className="wide-standard-container mx-auto w-full max-w-[390px] sm:max-w-[560px] lg:max-w-none">
          <MotionPageCard className="text-center">
            <MotionStaggerItem>
            ...
            <MotionPressable className="mt-6">
              <Button
                asChild
                size="lg"
                className="wide-action h-[52px] w-full rounded-[12px] bg-blue-600 text-white shadow-[0_0_30px_rgba(37,99,235,0.5)] hover:bg-blue-500"
              >
